...
sm <- renormalizeSignalMatrices(sm)
plotEnrichedHeatmaps(smb, trim=0.95, colors = c("white","darkred"), minRowVal = 10)
...
plotEnrichedHeatmaps(sm.top, trim=0.95, minRowVal = 12, colors = c("white","darkred"))
```
...
tss.sm <- signal2Matrix(tracks, granges(tss), w=10, extend=1000)
tss.sm <- renormalizeSignalMatrices(tss.sm, scaleFactors = nf)
plotEnrichedHeatmaps(tss.sm, trim=0.95, colors=c("white","darkred"))
```
